...
def train(args):
    ...
    print("start to create vllm engine")
    vllm_engines = None
    ...
    print("start to create actor model")
    ...
    print("start to create ref model")
    if args.init_kl_coef == 0:
        ref_model = None
    else:
    ...
    print("start to create critic model")
    ...
    print("start to create reward model")
    ...
    print("start to init reference/reward/actor model")
    ...
    print("start to train actor model")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_grader_result_path", type=str, default="grader result path")
    parser.add_argument("--save_rollout_path", type=str, default="")

    ...
    def __init__(
        ...
        **generate_kwargs,
        ...
        if self.strategy.args.use_wandb and self.strategy.is_rank_0():
            ...
            self._wandb = wandb
            if strategy.args.wandb_host and strategy.args.wandb_api_key:
                wandb.login(host=strategy.args.wandb_host, key=strategy.args.wandb_api_key)
    ...
    def fit(
        ...
        for episode in range(start_episode, args.num_episodes):
            ...
            for rand_prompts, labels in self.prompts_dataloader:
                ...
                if args.save_rollout_path:
                    self.strategy.save_rollout_data(self.replay_buffer.to_data_list(),
                                                args.save_rollout_path, episode, steps)
